...
./android/gradlew -p android --no-daemon :core:test :core:codecJar :app:testDebugUnitTest :app:lintDebug :app:assembleDebug :app:assembleRelease :testplayer:assembleDebug 2>&1 | tee build/evidence/android-build.log
